...
## 🌟🤖 Future Plan ##
 ...
 #### If I get access to the health data, preferably the data from the Public Health Centres (PHC) in and around the areas where the sensors are placed, I plan to explore correlation between diseases (especially respiratory) with the levels of pollutants for that location in the same temporal segment. ####
